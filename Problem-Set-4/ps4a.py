...
WORDLIST_FILENAME = "/home/tasos/PycharmProjects/6001x/ProblemSet4/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    handCopy = hand.copy()
    for w in word:
        if w in hand.keys() and handCopy[w] >= 1:
            handCopy[w] -= 1
        else:
            return False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore += earned
                print '\"', word, '\"earned', earned, 'points. Total:', totalScore, 'points'
                print
